...
use App\View\Cell\DocsCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\DocsCell Test Case
 */
class DocsCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Docs = new DocsCell($this->request, $this->response);
    }
