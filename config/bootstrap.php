 ...
 */
try {
    Configure::config('cakeapp', new PhpConfig());
    Configure::load('cakeapp', 'cakeapp', false);
} catch (\Exception $e) {
    exit($e->getMessage() . "\n");
}
...
//CakeApp Core plugins
Plugin::load('CakeBootstrap', ['routes' => true]);
Plugin::load('CakeFontAwesome', ['bootstrap' => false, 'routes' => true]);
Plugin::load('CakeAuth', ['routes' => true]);
Plugin::load('CakeFile', ['routes' => true]);
Plugin::load('CakeHighlight');
Plugin::load('MayMeow');
Plugin::load('CakeLogs', ['bootstrap' => false, 'routes' => true]);
Plugin::load('CakeApp', ['bootstrap' => false, 'routes' => true]);


// CakeApp Community Edition plugins

Plugin::load('CakeStorage', ['bootstrap' => false, 'routes' => true]);
...
Plugin::load('CakeService', ['bootstrap' => false, 'routes' => true]);

Plugin::load('CakeTaxonomy', ['bootstrap' => false, 'routes' => true]);

Plugin::load('CakeConfigure', ['bootstrap' => false, 'routes' => true]);
