...
class AccessTokensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'auth_application_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'expires' => '2017-04-03 21:24:12',
            'created' => '2017-04-03 21:24:12'
        ],
    ];
}
