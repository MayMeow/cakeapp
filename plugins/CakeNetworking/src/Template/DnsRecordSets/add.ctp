    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-body">
                    <h4 class="page-header">Record set</h4>
                    <?php
                    echo $this->Form->input('dns_name', ['help' => 'Some help text']);
                    echo $this->Form->input('domain_id', ['prepend' => '.', 'append' => '.'], ['options' => $domains]);
                    echo $this->Form->input('type', ['options' => $recordTypes]);
                    echo $this->Form->input('ttl', ['append' => 'seconds', 'value' => '600']);
                    ?>
                    <h4 class="page-header">Data values</h4>
                    <?php
                    echo $this->Form->input('dns_values.0.name', ['label' => 'Data value']);
                    ?>
                </div>
