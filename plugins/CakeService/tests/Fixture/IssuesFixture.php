<?php
namespace CakeService\Test\Fixture;
...
class IssuesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'estimate' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'finished' => 1,
            'created' => '2017-06-20 11:45:41',
            'modified' => '2017-06-20 11:45:41'
        ],
    ];
}
