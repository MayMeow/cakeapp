<span style="overflow: visible; width: 110px;">
                    ...
                    <div class="m-dropdown__content">
                        <ul class="m-nav">
                            ...
                            <li class="m-nav__item">
                                <a href="<?= $this->Url->build(['action' => 'view', $slug])?>" class="m-nav__link">
    ...
    <a href="<?= $this->Url->build(['action' => 'view', $slug])?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill">
