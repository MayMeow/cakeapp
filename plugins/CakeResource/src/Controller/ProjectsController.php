 ...
 *
 * @property \CakeResource\Model\Table\ProjectsTable $Projects
 */
class ProjectsController extends AppController
{
    ...
    public function isAuthorized($user) : bool
    {
        ...
        if (in_array($this->request->getParam('action'), ['edit', 'delete', 'addMember'])){
            ...
            if ($this->Projects->isOwnedBy($id, $user['id'])) {
                return true;
            }
        }
    ...
    public function index()
    {
        ...
        $resourceGroups = $this->paginate($this->Projects);
    ...
    {
        $resourceGroup = $this->Projects->findBySlug($slug)
    ...
    public function addMember($id = null)
    {
        ...
        $resourceGroupMember = $this->ProjectsUsers->newEntity();
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->ProjectsUsers->save($resourceGroupMember)) {
    ...
    public function add()
    {
        $resourceGroup = $this->Projects->newEntity();
        ...
        if ($this->request->is('post')) {
            $resourceGroup = $this->Projects->patchEntity($resourceGroup, $this->request->data);
            $resourceGroup->uid = '';
            $resourceGroup->user_id = $this->Auth->user('id');
            $resourceGroup->slug = $resourceGroup->name;
            if ($this->Projects->save($resourceGroup)) {
                $this->Flash->success(__('The resource group has been saved.'));
    ...
    {
        $resourceGroup = $this->Projects->get($id, [
            'contain' => []
        ]);
    ...
    public function delete($id = null)
    {
        ...
        $resourceGroup = $this->Projects->get($id);
        if ($this->Projects->delete($resourceGroup)) {
