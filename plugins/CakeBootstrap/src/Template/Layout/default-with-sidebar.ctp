...
<head>
    ...
    <?php echo $this->Html->css('CakeFontAwesome.font-awesome-regular'); ?>
...
<div class="gl-content" id="cake-vue-app">
    ...
    <div class="sidebar-wrapper" style="left: 220px; height: 100%; width: 220px; position: fixed; margin-left: -220px; background-color: #fafbfc; border-right: #e5e5e5 1px solid;">
